...
import UpdateDisasterCountPage from "./pages/update-disaster-count";
...
function App() {
  return (
    <Routes>
      ...
      <Route path='/disasters/edit/:id/count' element={<RequireAuth><UpdateDisasterCountPage /></RequireAuth>} />
